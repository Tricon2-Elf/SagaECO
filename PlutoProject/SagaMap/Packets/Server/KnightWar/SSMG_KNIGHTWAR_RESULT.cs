...
namespace SagaMap.Packets.Server
{
    public class SSMG_KNIGHTWAR_RESULT : Packet
    {
        ...
        {
            set { this.PutByte((byte)value, 7); }
        }

        public Country Rank2Country
        {
            set { this.PutByte((byte)value, 8); }
        }

        public Country Rank3ountry
        {
            set { this.PutByte((byte)value, 9); }
        }
        ...
        {
            set { this.PutInt(value, 16); }
        }

        public int Rank3Point
        {
            set { this.PutInt(value, 20); }
        }

        public int Rank4Point
        {
            set { this.PutInt(value, 24); }
        }

        public int ExpBonus
        {
            set { this.PutInt(value, 45); }
        }

        public int ExpPenalty
        {
            set { this.PutInt(value, 49); }
        }

        public int ExpScoreBonus
        {
            set { this.PutInt(value, 53); }
        }

        public int JexpBonus
        {
            set { this.PutInt(value, 57); }
        }
        public int JexpPenalty
        {
            set { this.PutInt(value, 61); }
        }

        public int JexpScoreBonus
        {
            set { this.PutInt(value, 65); }
        }
        public int CPBouns
        {
            set { this.PutInt(value, 69); }
        }
    }
}
