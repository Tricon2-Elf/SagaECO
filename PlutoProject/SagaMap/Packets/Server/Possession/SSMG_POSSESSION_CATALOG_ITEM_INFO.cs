...
namespace SagaMap.Packets.Server
{
    public class SSMG_POSSESSION_CATALOG_ITEM_INFO : Packet
    {
        ...
        public int HP
        {
            set { this.PutInt(value, 13); }
        }
        public int MP
        {
            set { this.PutInt(value, 17); }
        }
        public int SP
        {
            set { this.PutInt(value, 21); }
        }
        ...
        public short DEF
        {
            set { this.PutShort(value, 46); }
        }
        public short MDEF
        {
            set { this.PutShort(value, 48); }
        }
        public short SAVOID
        {
            set { this.PutShort(value, 50); }
        }
        public short LAVOID
        {
            set { this.PutShort(value, 52); }
        }
        public byte X
        {
            set { this.PutByte(value, 54); }
        }
        public byte Y
        {
            set { this.PutByte(value, 55); }
        }
    }
}
