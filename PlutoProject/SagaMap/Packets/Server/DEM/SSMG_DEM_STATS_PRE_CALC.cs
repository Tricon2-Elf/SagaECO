...
namespace SagaMap.Packets.Server
{
    public class SSMG_DEM_STATS_PRE_CALC : Packet
    {
        ...
        {
            set { this.PutUShort(value, 33); }
        }

        public ushort HitCritical
        {
            set { this.PutUShort(value, 35); }
        }

        public ushort AvoidMelee
        {
            set { this.PutUShort(value, 37); }
        }

        public ushort AvoidRanged
        {
            set { this.PutUShort(value, 39); }
        }

        public ushort AvoidMagic
        {
            set { this.PutUShort(value, 41); }
        }
        ...
        public short ASPD
        {
            set { this.PutShort(value, 51); }
        }

        public short CSPD
        {
            set { this.PutShort(value, 53); }
        }

        public ushort HP
        {
            set { this.PutUShort(value, 64); }
        }

        public ushort MP
        {
            set { this.PutUShort(value, 66); }
        }

        public ushort SP
        {
            set { this.PutUShort(value, 68); }
        }

        public ushort Capacity
        {
            set { this.PutUShort(value, 70); }
        }

        public ushort Payload
        {
            set { this.PutUShort(value, 72); }
        }
    }
}
