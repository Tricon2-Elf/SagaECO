...
namespace SagaMap.Packets.Server
{
    public class SSMG_PARTNER_INFO_BASIC : Packet
    {
        ...
        {
            set { this.PutUInt(value, 16); }
        }
        public byte AIMode
        {
            set { this.PutByte(value, 20); }
        }
        public uint MaxNextFeedTime //infinity feed time to show --:--
        {
            set { this.PutUInt(value, 21); }
        }
        ...
        {
            set { this.PutByte(6, 30); }
        }
        public byte Perk0
        {
            set { this.PutByte(value, 31); }
        }
        public byte Perk1
        {
            set { this.PutByte(value, 32); }
        }
        public byte Perk2
        {
            set { this.PutByte(value, 33); }
        }
        public byte Perk3
        {
            set { this.PutByte(value, 34); }
        }
        public byte Perk4
        {
            set { this.PutByte(value, 35); }
        }
        public byte Perk5
        {
            set { this.PutByte(value, 36); }
        }
        public uint WeaponID
        {
            set { this.PutUInt(value, 37); }
        }
        public uint ArmorID
        {
            set { this.PutUInt(value, 41); }
        }
    }
}
