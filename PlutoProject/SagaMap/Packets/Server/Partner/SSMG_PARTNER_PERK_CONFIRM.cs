...
namespace SagaMap.Packets.Server
{
    public class SSMG_PARTNER_PERK_CONFIRM : Packet
    {
        ...
        {
            set { this.PutUShort(value, 44); }
        }

        public ushort MaxMAGATK
        {
            set { this.PutUShort(value, 46); }
        }
        public ushort DEF
        {
            set { this.PutUShort(value, 48); }
        }
        public ushort DEFAdd
        {
            set { this.PutUShort(value, 50); }
        }
        public ushort MDEF
        {
            set { this.PutUShort(value, 52); }
        }
        public ushort MDEFAdd
        {
            set { this.PutUShort(value, 54); }
        }
        public ushort ShortHit
        {
            set { this.PutUShort(value, 56); }
        }
        public ushort LongHit
        {
            set { this.PutUShort(value, 58); }
        }
        public ushort ShortAvoid
        {
            set { this.PutUShort(value, 60); }
        }
        public ushort LongAvoid
        {
            set { this.PutUShort(value, 62); }
        }
        public short ASPD
        {
            set { this.PutShort(value, 64); }
        }
        public short CSPD
        {
            set { this.PutShort(value, 66); }
        }
    }
}
