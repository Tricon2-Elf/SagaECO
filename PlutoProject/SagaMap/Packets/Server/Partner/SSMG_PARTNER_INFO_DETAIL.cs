...
namespace SagaMap.Packets.Server
{
    public class SSMG_PARTNER_INFO_DETAIL : Packet
    {
        ...
        {
            set { this.PutUShort(value, 34); }
        }

        public ushort MaxMAGATK
        {
            set { this.PutUShort(value, 36); }
        }
        public ushort DEF
        {
            set { this.PutUShort(value, 38); }
        }
        public short DEFAdd
        {
        ...
        public short ASPD
        {
            set { this.PutShort(value, 54); }
        }
        public short CSPD
        {
            set { this.PutShort(value, 56); }
        }
    }
}
