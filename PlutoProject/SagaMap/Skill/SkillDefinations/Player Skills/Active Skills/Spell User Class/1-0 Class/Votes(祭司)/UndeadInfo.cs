    ...
    public class UndeadInfo : ISkill
    {
        ...
        public void Proc(Actor sActor, Actor dActor, SkillArg args, byte level)
        {
            ...
            Knowledge skill = new Knowledge(
                ...
                sActor,
                "UndeadInfo",
                SagaDB.Mob.MobType.UNDEAD,
                SagaDB.Mob.MobType.UNDEAD_BOSS,
                SagaDB.Mob.MobType.UNDEAD_BOSS_BOMB_SKILL,
                SagaDB.Mob.MobType.UNDEAD_BOSS_CHAMP_BOMB_SKILL_NOTPTDROPRANGE,
                SagaDB.Mob.MobType.UNDEAD_BOSS_SKILL,
                SagaDB.Mob.MobType.UNDEAD_BOSS_SKILL_CHAMP,
                SagaDB.Mob.MobType.UNDEAD_BOSS_SKILL_NOTPTDROPRANGE,
                SagaDB.Mob.MobType.UNDEAD_NOTOUCH,
