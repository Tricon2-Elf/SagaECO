...
namespace SagaMap.Partner
{
    ...
    public class AnAIMode
    {
        ...
        int eventAttackingSkillRateOnLongRange,
            eventAttackingSkillRateOnShortRange;
        Dictionary<uint, int> eventAttackingSkillCDOnLongRange,
            eventAttackingSkillCDOnShortRange;
        ...
        /// </summary>
        public Dictionary<uint, int> EventAttackingOnShortRange
        {
            get { return this.eventAttackingOnShortRange; }
            set { this.eventAttackingOnShortRange = value; }
        }

        /// <summary>
        /// 怪物使用技能的CD(近程)，Key＝技能，Value＝CD
        /// </summary>
        public Dictionary<uint, int> EventAttackingSkillCDOnShortRange
        {
            get { return this.eventAttackingSkillCDOnShortRange; }
            set { this.eventAttackingSkillCDOnShortRange = value; }
        }

        /// <summary>
        /// 怪物在攻击时(远程)，需要使用技能时的技能列表，Key＝技能，Value＝几率
        /// </summary>
        public Dictionary<uint, int> EventAttackingOnLongRange
        {
            get { return this.eventAttackingOnLongRange; }
            set { this.eventAttackingOnLongRange = value; }
        }
        ...
        public int MinimumRange
        {
            ...
            set { this.minimumRange = value; }
        }

        /// <summary>
        /// 怪物在攻击时(近程)，使用技能的几率
        /// </summary>
        public int EventAttackingSkillRateOnShortRange
        {
            get { return this.eventAttackingSkillRateOnShortRange; }
            set { this.eventAttackingSkillRateOnShortRange = value; }
        }

        /// <summary>
        /// 怪物在攻击时(远程)，使用技能的几率
        /// </summary>
        public int EventAttackingSkillRateOnLongRange
        {
            get { return this.eventAttackingSkillRateOnLongRange; }
            set { this.eventAttackingSkillRateOnLongRange = value; }
        }
    }
}
