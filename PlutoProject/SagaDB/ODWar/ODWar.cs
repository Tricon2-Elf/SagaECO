...
namespace SagaDB.ODWar
{
    ...
    public class ODWar
    {
        ...
        {
            get { return this.symbolTrash; }
            set { this.symbolTrash = value; }
        }
        ...
        /// 敌人比较强的攻击波
        /// </summary>
        public Wave WaveStrong
        {
            get { return this.waveStrong; }
            set { this.waveStrong = value; }
        }

        /// <summary>
        /// 敌人比较弱的攻击波
        /// </summary>
        public Wave WaveWeak
        {
            get { return this.waveWeak; }
            set { this.waveWeak = value; }
        }
