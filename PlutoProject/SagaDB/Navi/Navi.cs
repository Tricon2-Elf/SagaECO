...
namespace SagaDB.Navi
{
    ...
    public class Event
    {
        ...
        {
            get { return this.displaySteps; }
            set { this.displaySteps = value; }
        }
        ...
        {
            get { return this.finishedSteps; }
            set { this.finishedSteps = value; }
        }
    ...
    public class Step
    {
        ...
        public bool Display
        {
            get { return (toBool(belongEvent.DisplaySteps &= (1 << ((int)id - 1)))); }
            set
            {
                if (value)
                {
        ...
        public bool Finished
        {
            get { return (toBool(belongEvent.FinishedSteps &= (1 << ((int)id - 1)))); }
            set
            {
                if (value)
                {
        ...
        {
            get { return this.belongEvent; }
            set { this.belongEvent = value; }
        }
