...
namespace SagaDB.Tamaire
{
    public class TamaireLending
    {
        ...
        public uint Lender
        {
            get { return this.lender; }
            set { this.lender = value; }
        }
        public byte Baselv
        {
            get { return this.baselv; }
            set { this.baselv = value; }
        }
        public byte JobType
        {
        ...
        public DateTime PostDue
        {
            get { return this.postdue; }
            set { this.postdue = value; }
        }
        ...
        {
            get { return this.maxLendings; }
            set { this.maxLendings = value; }
        }
    }
}
