...
namespace SagaDB.FFarden
{
    ...
    public class FFarden
    {
        ...
        public byte ObMode
        {
            get { return this.obmode; }
            set { this.obmode = value; }
        }
        ...
        {
            get { return this.healthmode; }
            set { this.healthmode = value; }
        }

        /// <summary>
        /// 飞空城的所持材料数(所持マテリアルポイント)
        /// </summary>
        public uint MaterialPoint
        {
            get { return this.materialpoint; }
            set { this.materialpoint = value; }
        }
        ...
        public uint FFexp
        {
            get { return this.ffexp; }
            set { this.ffexp = value; }
        }
        ...
        public uint FFFexp
        {
            get { return this.fffexp; }
            set { this.fffexp = value; }
        }
        ...
        public uint SULevel
        {
            get { return this.sulevel; }
            set { this.sulevel = value; }
        }
        ...
        public uint FFSUexp
        {
            get { return this.ffsuexp; }
            set { this.ffsuexp = value; }
        }
        ...
        public uint BPLevel
        {
            get { return this.bplevel; }
            set { this.bplevel = value; }
        }
        ...
        public uint FFBPexp
        {
            get { return this.ffbpexp; }
            set { this.ffbpexp = value; }
        }

        /// <summary>
        /// 飞空城DEM系等级
        /// </summary>
        public uint DEMLevel
        {
            get { return this.demlevel; }
            set { this.demlevel = value; }
        }

        /// <summary>
        /// 飞空城DEM系经验值
        /// </summary>
        public uint FFDEMexp
        {
            get { return this.ffdemexp; }
            set { this.ffdemexp = value; }
        }

        /// <summary>
        /// 飞空城的材料点数消耗(マテリアルコスト)
        /// </summary>
        public uint MaterialConsume
        {
            get { return this.materialconsume; }
            set { this.materialconsume = value; }
        }
