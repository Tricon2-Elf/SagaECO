...
namespace SagaDB.Actor
{
    public class Status
    {
        ...
        public ushort min_atk_bs,
            max_atk_bs,
            min_matk_bs,
            max_matk_bs;
        public ushort def_bs,
            mdef_bs; //%def
        public short def_add_bs,
            mdef_add_bs; //-def
        public short guard_bs;
        public ushort hit_melee_bs,
            hit_ranged_bs,
            hit_magic_bs,
            hit_critical_bs;
        public ushort avoid_melee_bs,
            avoid_ranged_bs,
            avoid_magic_bs,
            avoid_critical_bs;
        public short aspd_bs,
            cspd_bs;
        public short hp_recover_bs,
            mp_recover_bs,
            sp_recover_bs;
        ...
        public ushort def,
            mdef; //%def
        public ushort atk_min_to_max_per,
            matk_min_to_max_per; //min to max up percentage of atks
        ...
        public short atk1_item,
            ...
            atk3_item,
            matk_item;
        public short atk1_rate_item = 100,
            atk2_rate_item = 100,
            atk3_rate_item = 100,
            matk_rate_item = 100;
        public short def_item,
            mdef_item;
        public short def_add_item,
            mdef_add_item;
        ...
        public short avoid_melee_item,
            ...
            avoid_magic_item,
            avoid_critical_item;
        public short aspd_item,
            cspd_item,
            aspd_item_limit,
            cspd_item_limit;
        public short aspd_rate_item = 100,
            cspd_rate_item = 100;
        ...
        //Iris Card bonus
        public short weapon_add_iris = 0,
            weapon_add_rate_iris = 0; //武器伤害直接增加用参数
        public short level_hit_iris = 0,
            level_avoid_iris = 0; //等级差命中与回避
        public short avoid_end_rate = 100; //最终回避计算
        public short physice_rate_iris = 100,
            magic_rate_iris = 100; //物理与魔法直接减少
        public short Element_down_iris = 100; //被属性攻击减少幅度
        public short foot_iris = 100,
            potion_iris = 100; //食物和药水
        ...
        public short pt_dmg_up_iris = 100,
        ...
        public short def_iris,
            mdef_iris;
        public short def_add_iris,
            mdef_add_iris;
        public short guard_iris = 0,
            volume_iris = 0,
            payl_add_iris = 0,
            volume_add_iris = 0; //负重体积相关
        ...
        public short aspd_iris,
            cspd_iris,
            aspd_iris_limit,
            cspd_iris_limit;
        public short aspd_rate_iris = 100,
            cspd_rate_iris = 100;
        public short str_iris = 0,
            dex_iris = 0,
            int_iris = 0,
            vit_iris = 0,
            agi_iris = 0,
            mag_iris = 0;
        public short hp_iris,
            sp_iris,
            mp_iris,
            payl_iris,
            hp_rate_iris = 100,
            sp_rate_iris = 100,
            mp_rate_iris = 100;
        public short sp_rate_down_iris = 100,
            mp_rate_down_iris = 100;
        public short hp_recover_iris,
            sp_recover_iris,
            mp_recover_iris;
        ...
        public short avoid_melee_skill,
            avoid_ranged_skill,
            avoid_magic_skill,
            avoid_critical_skill;
        public short aspd_skill,
            cspd_skill,
            aspd_skill_limit,
            cspd_skill_limit;
        public short aspd_rate_skill = 100,
            cspd_rate_skill = 100;
        ...
        //Another bonus
        public short hit_melee_anthor,
            hit_ranged_anthor;
        public short avoid_melee_anthor,
            avoid_ranged_anthor;
        public short def_add_anthor,
            mdef_add_anthor;
        public short hp_anthor,
            sp_anthor,
            mp_anthor;
        public short str_anthor,
            dex_anthor,
            int_anthor,
            vit_anthor,
            agi_anthor,
        ...
        //tamaire bonus
        public short hit_melee_tamaire,
            hit_ranged_tamaire;
        public short avoid_melee_tamaire,
            avoid_ranged_tamaire,
            cri_tamaire;
        public short def_add_tamaire,
            mdef_add_tamaire;
        public short hp_tamaire,
            sp_tamaire,
            mp_tamaire;
        public short min_atk1_tamaire,
            ...
            min_matk_tamaire,
            max_matk_tamaire;
        public short aspd_tamaire,
            cspd_tamaire;

        //title bonus
        public short hit_melee_tit,
            hit_ranged_tit;
        public short avoid_melee_tit,
            avoid_ranged_tit,
            cri_tit;
        public short def_add_tit,
            mdef_add_tit;
        public short hp_tit,
            sp_tit,
            mp_tit,
        ...
        //宠物凭依 bonus
        public short hit_melee_petpy,
            hit_ranged_petpy;
        public short avoid_melee_petpy,
            avoid_ranged_petpy,
            cri_petpy,
            cspd_petpy,
            aspd_petpy;
        public short def_add_petpy,
            mdef_add_petpy;
        public short hp_petpy,
            sp_petpy,
            mp_petpy,
            hprecov_petpy,
            mprecov_petpy,
            sprecov_petpy;
        public short str_petpy,
            dex_petpy,
            int_petpy,
            vit_petpy,
            agi_petpy,
        ...
        public float damage_atk1_discount,
            damage_atk2_discount,
            damage_atk3_discount;
        ...
        public short hit_melee_possession,
            hit_ranged_possession,
            avoid_melee_possession,
            avoid_ranged_possession;
