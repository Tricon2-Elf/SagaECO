namespace SagaDB.Actor
{
    public partial class Buff
    {
        ...
        {
            get { return buffs[8].Test(0x00008000); }
            set { buffs[8].SetValue(0x00008000, value); }
        }
        public bool 三转せーチウィークポイント
        {
            get { return buffs[8].Test(0x00010000); }
            set { buffs[8].SetValue(0x00010000, value); }
        }
        public bool Unknow4
        {
            get { return buffs[8].Test(0x00020000); }
        ...
        {
            get { return buffs[8].Test(0x00040000); }
            set { buffs[8].SetValue(0x00040000, value); }
        }
        public bool Unknow6
        {
            get { return buffs[8].Test(0x00080000); }
            set { buffs[8].SetValue(0x00080000, value); }
        }
        public bool Unknow7
        {
            get { return buffs[8].Test(0x00100000); }
            set { buffs[8].SetValue(0x00100000, value); }
        }
        public bool Unknow8
        {
            get { return buffs[8].Test(0x00200000); }
            set { buffs[8].SetValue(0x00200000, value); }
        }
        public bool Unknow9
        {
            get { return buffs[8].Test(0x00400000); }
        ...
        {
            get { return buffs[8].Test(0x20000000); }
            set { buffs[8].SetValue(0x20000000, value); }
        }
        public bool Unknow17
        {
            get { return buffs[8].Test(0x40000000); }
